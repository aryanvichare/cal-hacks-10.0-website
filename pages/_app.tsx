  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Cal Hacks is the world's largest collegiate hackathon hosted at UC Berkeley. Together we assemble in SF for a weekend of hacking, friendship, and crazy ideas." />
        

        <meta key="og_locale" property="og:locale" content="en_US" />
        <meta key="og_type" property="og:type" content="website" />
        <meta property="og:title" content="Cal Hacks" />
        <meta property="og:description" content="Cal Hacks is the world's largest collegiate hackathon hosted at UC Berkeley. Together we assemble in SF for a weekend of hacking, friendship, and crazy ideas." />
        ...
        <meta name="twitter:description" content="Cal Hacks is the world's largest collegiate hackathon hosted at UC Berkeley. WTogether we assemble in SF for a weekend of hacking, friendship, and crazy ideas." />
